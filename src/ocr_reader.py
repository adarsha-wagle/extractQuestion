...
if __name__ == "__main__":
    ...
    # Try all methods first to see which works best
    print("=== Trying all preprocessing methods ===")
    results = ocr_reader.process_image(image_path,"low_contrast", try_all=True, save_debug=True)
    ...
    # Once you know which method works best for your images:
    # best_method = 'black_text'  # Replace with your best method
    # print("\n=== Using best method ===")
    # best_result = ocr_reader.process_image(image_path, preprocess_method=best_method)
    # print(best_result)